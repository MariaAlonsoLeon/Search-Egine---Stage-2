...
public class BarChartCrawlerDownloads extends JFrame {

    private JFreeChart chart;

    public BarChartCrawlerDownloads(String title) {
        super(title);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            try {
                BarChartCrawlerDownloads chart = new BarChartCrawlerDownloads("Benchmark Results");
                chart.createChart("plotGenerator/src/main/resources/json/downloader_benchmark_results.json");
                chart.saveChartAsImage("crawler_download.png");
            } catch (IOException e) {
