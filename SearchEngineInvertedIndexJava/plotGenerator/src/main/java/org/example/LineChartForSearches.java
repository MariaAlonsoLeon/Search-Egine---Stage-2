...
public class LineChartForSearches extends JFrame {

    private JFreeChart chart;

    public LineChartForSearches(String title) {
        super(title);
    ...
    private void customizeChartAppearance() {
        ...
        */
        //renderer.setSeriesPaint(3, Color.decode("#D32F2F"));
        //renderer.setSeriesPaint(0, Color.decode("#7cb6f0"));
        //renderer.setSeriesPaint(1, Color.decode("#FF9800"));
        //renderer.setSeriesPaint(2, Color.decode("#4CAF50"));
        //renderer.setSeriesPaint(3, Color.decode("#D32F2F"));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            /*List<DataPoint> data = List.of(
                    new DataPoint(10, 14, 10, 29),
                    new DataPoint(50, 9, 6, 6),
                    new DataPoint(100, 8, 6, 10),
                    new DataPoint(500, 11, 6, 5),
                    new DataPoint(1000, 7, 7, 7)
            );*/


            LineChartForSearches chart = new LineChartForSearches("Benchmark Performance by Search Type");
